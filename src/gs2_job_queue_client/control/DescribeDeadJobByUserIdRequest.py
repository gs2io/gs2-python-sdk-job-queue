...
class DescribeDeadJobByUserIdRequest(Gs2BasicRequest):

    class Constant(Gs2JobQueue):
        FUNCTION = "DescribeDeadJobByUserId"
    ...
    def __init__(self, params=None):
        ...
        """
        super(DescribeDeadJobByUserIdRequest, self).__init__(params)
        if params is None:
    ...
    def with_queue_name(self, queue_name):
        ...
        :type queue_name: unicode
        :return: this
        :rtype: DescribeDeadJobByUserIdRequest
        """
